...
public class GenericStackTester {
    ...
    public static void main(String[] args) {
        ...
        GenericStack<Integer> s = new GenericStack<Integer>(Integer.class, 64);
        ...
        while (true) {
            ...
            switch (menu) {
                case 1:
                    ...
                    try {
                        s.push(x);
                    } catch (GenericStack.OverflowIntStackException e) {
                ...
                case 2:
                    ...
                    } catch (GenericStack.EmptyIntStackException e) {
